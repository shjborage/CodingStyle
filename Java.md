...
[3.1. 许可证（License）或版权声明（Copyright）](#31-许可证（License）或版权声明（Copyright）)  
[3.2. package语句](#32-package语句)  
[3.3. import语句](#33-import语句)  
[3.3.1. 禁止通配符import](#331-禁止通配符import)  
[3.3.2. 不换行](#21-文件名)  
[3.3.3. 顺序](#21-文件名)  
[3.3.4. 删除未使用的import语句](#21-文件名)  
[3.4. 类声明](#21-文件名)  
[3.4.1. 唯一的顶层类](#21-文件名)  
[3.4.2. 类成员顺序：有一定的逻辑顺序即可](#21-文件名)  
[3.4.3. 重载（Overload）方法必须放在一起](#21-文件名)  

[4. 代码格式](#21-文件名)  

[4.1. 花括号](#21-文件名)  
[4.1.1. 不得省略花括号](#21-文件名)  
[4.1.2. 非空块中花括号的使用](#21-文件名)  
[4.1.3. 空代码块中花括号的使用](#21-文件名)  
[4.2. 块缩进：4个空格](#21-文件名)  
[4.3. 每行只写一条语句](#21-文件名)  
[4.4. 列宽：120字符](#21-文件名)  
[4.5. 换行](#21-文件名)  
[4.5.1. 何处换行](#21-文件名)  
[4.5.2. 至少用8个以上的空格缩进连续的行](#21-文件名)  
[4.6. 空白](#21-文件名)  
[4.6.1. 空行](#21-文件名)  
[4.6.2. 空格](#21-文件名)  
[4.7. 表达式圆括号](#21-文件名)  
...
[4.8.2. 变量声明](#21-文件名)  
[4.8.3. 数组](#21-文件名)  
[4.8.4. switch语句](#21-文件名)  
[4.8.5. 注解（Annotation）](#21-文件名)  
[4.8.6. 注释](#21-文件名)  
[4.8.7. 修饰符](#21-文件名)  
[4.8.8. 数字](#21-文件名)  
...
[5.2.6. 参数命名](#21-文件名)  
[5.2.7. 局部变量命名](#21-文件名)  
[5.2.8. 泛型类型变量命名](#21-文件名)  
[5.3. 驼峰命名方式定义](#21-文件名)  

[6. 编程实践](#21-文件名)  

[6.1. 使用@Override](#21-文件名)  
[6.2. 异常捕获：不推荐Ignore](#21-文件名)  
[6.3. 静态成员：](#21-文件名)  
[6.4. Finalizer：禁用](#21-文件名)  
...
[7.1.3. 条目相关](#21-文件名)  
[7.2. 摘要](#21-文件名)  
[7.3. Javadoc应该应用在哪些场合](#21-文件名)  
[7.3.1. 例外情况：方法本身已经足够说明用途](#21-文件名)  
[7.3.2. 例外情况：覆盖（Override）方法](#21-文件名)  
